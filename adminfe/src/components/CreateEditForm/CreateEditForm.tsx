...
const CreateEditForm = ({ props, method, url }: any) => {
  ...
  return (
    <div className="form-wrapper">
      ...
      <div className="form-descriptions">
        ...
        <Editor
          ...
          init={{
            ...
            toolbar:
              ...
              "removeformat | help | preview | code",
            content_style:
          ...
          onEditorChange={(e) => {
            ...
            console.log(props.values["interview-description"]);
          }}
        />
        ...
        <Editor
          ...
          onEditorChange={(e) => {
            ...
            console.log(props.values["recipe-description"]);
          }}
        />
        <label htmlFor="movement-description">Movement Description:</label>
        <Editor
          onInit={(evt: any, editor: any) => (editorRef.current = editor)}
          initialValue="<p>This is the initial content of the editor.</p>"
          apiKey="no-api-key"
          ...
          onEditorChange={(e) => {
            ...
            console.log(props.values["movement-description"]);
          }}
        />
        ...
        <Editor
          ...
          onEditorChange={(e) => {
            ...
            console.log(props.values["sutra-description"]);
          }}
        />
      </div>
    </div>
